...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>JS01__Update_UserId_on_Contact</fullName>
        <field>JS01__UserId__c</field>
        <formula>JS01__User__c</formula>
...
OtherPhone 
    ...
    <rules>
        <fullName>JS01__Update UserId on Contact</fullName>
        <actions>
            <name>JS01__Update_UserId_on_Contact</name>
